...
public class MockDataGenerator {
    public static void main(String[] args) {
        ...
        mockData(sqlSessionFactory, 10_000);
    }

    private static void mockData(SqlSessionFactory sqlSessionFactory, int howMany) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(ExecutorType.BATCH)) {
            List<News> currentNews = sqlSession.selectList("com.github.maxiaoda.MockMapper.selectNews");
            ...
            try {
                while (count-- > 0) {
                    ...
                    sqlSession.insert("com.github.maxiaoda.MockMapper.insertNews", newsToBeInserted);
